				...
				$.get("api/pos/get/", { "external_id": external_id }, function (data) {
					...
					if (data.paging.total > 0) {
						...
						var orderJSON = {
							...
							"notification_url": "https://crzarateok-mp-qr.herokuapp.com/api/notifications/index.php",
							"items": items
						};
						console.log("JSON Crea orden:");
